...
public class LogicTest {
    ...
    public void new_DeliveryRepoNull() {
        ...
        //assert
        assertEquals("deliveryRepo", exception.getMessage());
    }
    ...
    public void changeOneDriver_HappyCase() {
        ...
        //assert
        verify(mockDriverRepo, times(1)).update(anyInt(), argument.capture(), eq(false));
    ...
    public void addVehicle_HappyCase() {
        ...
        var vehiclePlateNumber = "AAA-111";
        var mockLog = mock(Logger.class);
        var mockDriverRepo = mock(IDriverRepository.class);
        var mockVehicleRepo = mock(IVehicleRepository.class);
    ...
    @Test
    public void changeOnePackage_HappyCase() {
        //arrange
        ArgumentCaptor<Double> argument = ArgumentCaptor.forClass(Double.class);
        ...
        //act
        logic.changeOnePackage(packageId, packages.getContent(), packages.getDestination(), 500, new Delivery(), packages.isSelected());

        //assert
        verify(mockPackageRepo, times(1)).update(anyInt(), eq(packages.getContent()), eq(packages.getDestination()), eq(packages.getRegistrationTime()),eq(500.0d), eq(null), eq(packages.isSelected()));
    }
    ...
    public void changeOnePackage_VehicleNotFound() {
        ...
        //act
        var exception = assertThrows(BusinessException.class, () ->
                logic.changeOnePackage(123, "94 Pizzas and a diet coke", "Pesti tanya", 0, null,false));
